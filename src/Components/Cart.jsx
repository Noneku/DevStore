...
//   useEffect(() => {
//     // Si le localStorage est vide, faites un appel API pour obtenir les articles
//     if (!cart.length) {
//       axios.get("/api/user/cart").then((response) => {
//         setCart(response.data);
//         // Sauvegarder les articles obtenus dans le localStorage
...
//   useEffect(() => {
//     // À chaque fois que le panier change, le mettre à jour dans le localStorage
